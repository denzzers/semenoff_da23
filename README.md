...
**Файл проекта:** [#1_Project_Исследование_надежности заемщиков.ipynb](https://github.com/denzzers/semenoff_da23/blob/main/%231_Project_Исследование_надежности%20заемщиков.ipynb)
|  | **Информация** | 
|:----:|----|
...
| Проект на nbviewer.org | [Посмотреть проект - Исследование надёжности заёмщиков](https://nbviewer.org/github/denzzers/semenoff_da23/blob/main/%231_Project_Исследование_надежности%20заемщиков.ipynb) |

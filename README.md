...
**Файл проекта:** [#1_Project_Исследование_надежности заемщиков.ipynb](https://github.com/denzzers/semenoff_da23/blob/main/%2301_Project_Исследование_надежности%20заемщиков.ipynb)
|  | **Информация** | 
|:----:|----|
